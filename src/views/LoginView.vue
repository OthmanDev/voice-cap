  ...
  <div class="min-h-screen flex items-center justify-center px-4">
    <div class="max-w-[500px]">
      <div class="text-center">
        <h1 class="text-4xl font-bold text-heading-100 leading-normal mb-6 xs:leading-[1.25]">
          ...
          <span class="relative inline-flex"
            ...
            <svg
              ...
              class="absolute start-0 h-2.5 text-primary-100 -bottom-0.5 w-36"
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
        ...
        <p class="text-[17px] leading-normal">
          By signing up, you will gain access to exclusive content, special offers, and be the first
          to hear about exciting news and updates.
        </p>
      </div>
      <div class="bg-white-100 border border-border-100 rounded-xl mt-6 p-6">
        <div class="grid gap-5">
          <div class="relative">
            <label class="text-sm text-heading-100 font-medium mb-1 block" for="new-pass"
              >Email Address</label
          ...
          <div class="relative">
            <label class="text-sm text-heading-100 font-medium mb-1 block" for="new-pass"
              >Password</label
            ><input type="password" class="form-field" placeholder="Enter your password" />
          </div>
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <a
                ...
                class="text-[15px] font-medium hover:text-primary-100"
              >
                Forgot Password?
              </a>
            </div>
