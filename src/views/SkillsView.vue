<template>
  ...
  <main class="p-6">
    <div class="grid gap-6">
        ...
        <div class="border-b border-border-100 p-4">
          <div class="flex items-center justify-between xs:flex-col xs:gap-4">
            <div>
              ...
              >
              <span
                >These skills are curated by the VoiceCab team. You can use them by adding them to
                your agent.
              </span>
            </div>
            ...
            >
              <div class="flex justify-between xs:flex-col xs:gap-4">
                <div class="flex flex-1 items-start gap-4 xs:flex-col xs:justify-center xs:items-center xs:text-center">
                  ...
                  >
                    <skill-icon class="w-6 h-6" />
                  </div>
                  <div class="flex-1 mt-1">
                    <h4 class="text-lg font-semibold text-heading-100 leading-none">
                      {{ skill.name }}
                    </h4>
                    <span class="text-[15px] font-medium mt-2 mb-1 block"
                      >Status: {{ skill.status }}</span
                    >
      ...
      <div class="border border-border-100 rounded-xl bg-white-100">
        <div class="border-b border-border-100 p-4">
          <span class="text-xl font-bold text-heading-100 block mb-1">Dispatch Integration</span>
        ...
        <div class="p-4">
          <div class="grid grid-cols-3 gap-4 sm:grid-cols-2 xs:grid-cols-1">
            <div
              ...
              class="border border-border-100 rounded-xl bg-white-100 p-4"
            >
              <div class="flex flex-1 flex-col items-center text-center gap-4">
                <div class="w-[70px] overflow-hidden flex items-center justify-center">
                  <svg
                    v-if="skill.name === 'TaxiCaller'"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 90 90"
                  >
                    <g transform="matrix(1.25,0,0,-1.25,-179.12875,494.61375)">
                      <g transform="scale(0.1,0.1)">
                        <path
                          style="fill: #fdd943"
                          d="m 2146.81,3325.62 c 0,-45.54 -36.97,-82.53 -82.54,-82.53 l -548.7,0 c -45.57,0 -82.54,36.99 -82.54,82.53 l 0,548.75 c 0,45.61 36.97,82.54 82.54,82.54 l 548.7,0 c 45.57,0 82.54,-36.93 82.54,-82.54 l 0,-548.75"
                        />
                        <path
                          style="fill: #231f20"
                ...
                <div class="flex-1">
                  ...
                  <div class="min-h-[180px]">
                    <ul class="mt-2 grid gap-1">
                      <li v-for="(item, index) in skill.data" :key="index">
                        <span class="text-[15px] font-medium" v-html="item"></span>
                      </li>
                    </ul>
                  </div>
                </div>
      ...
      skills: [
        {
          ...
          name: 'TaxiCaller',
          data: [
            '<b>Booking</b>: Schedule rides with dispatch integration.',
            '<b>Cancel</b>: Process ride cancellation requests.',
            '<b>Confirm</b>: Confirm and send ride details to users.',
            '<b>Locate Driver</b>: Share real-time driver location.',
            '<b>Refund</b>: Manage refunds for cancellations or overcharges.',
            '<b>Modify Booking</b>: Update ride details (pickup/drop-off, time).',
          ],
        },
        {
          id: 2,
          name: 'BookALimo',
          data: [
            '<b>Luxury Booking</b>: Reserve premium vehicles.',
            '<b>Cancel</b>: Cancel high-priority bookings.',
            '<b>Ride Confirmation</b>: Confirm luxury ride requests.',
            '<b>Locate Chauffeur</b>: Provide chauffeur’s real-time location.',
            '<b>Customer Feedback</b>: Collect feedback for VIP experiences.',
          ],
        },
      ],
    }
